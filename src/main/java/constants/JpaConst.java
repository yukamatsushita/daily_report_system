...
//※インターフェイスに定義した変数はpublic static final修飾子がついているとみなされる
...
public interface JpaConst {
    ...
    //社員番号とハッシュ化(ハッシュ関数を用いた文字列)済パスワードを条件に未削除の従業員を取得する
    //従業員がログインするときに、社員番号とパスワードが正しいかをチェック
    ...
    String Q_REP_GET_ALL_MINE = ENTITY_REP + ".getAllMine"; //従業員1人を指定して、その人が作成した日報のみを抽出
    String Q_REP_GET_ALL_MINE_DEF = "SELECT r FROM Report AS r WHERE r.employee = :" + JPQL_PARM_EMPLOYEE
            + " ORDER BY r.id DESC";
    //指定した従業員が作成した日報の件数を取得する
    String Q_REP_COUNT_ALL_MINE = ENTITY_REP + ".countAllMine"; //従業員1人を指定して、その人が作成した日報のデータ件数を取得
